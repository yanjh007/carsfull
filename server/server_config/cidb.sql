...
-- ----------------------------
BEGIN;
INSERT INTO `ci_sessions` VALUES ('88d30b00a7d27efaca8d9aba48a7d209', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10) AppleWebKit/600.1.25 (KHTML, like Gecko) Version/8.0 Safari/600.1.25', '1413962192', 'a:2:{s:9:\"user_data\";s:0:\"\";s:9:\"logged_in\";a:4:{s:2:\"id\";s:1:\"1\";s:5:\"login\";s:5:\"yanjh\";s:4:\"role\";s:3:\"100\";s:4:\"name\";s:9:\"颜建华\";}}');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `moduleitems` VALUES ('4', '10', '0', '5', null, '多选题 共6题 20分'), ('4', '11', '1', '2', '8', '三角形的内角之和'), ('4', '10', '0', '6', null, '填空题 共2题 10分'), ('4', '13', '4', '7', '5', '中国的英文简称为'), ('4', '12', '3', '5', '10', '下列那些国家是欧'), ('4', '21', '5', '9', '20', '简要概述四川主要'), ('4', '10', '0', '8', null, '简答题'), ('4', '10', '0', '1', null, '单选题 共5题 10分'), ('4', '10', '0', '1', null, '测试说明'), ('4', '10', '0', '16', null, '结束说明'), ('26', '11', '0', '4', '0', '美国首都是 \n\n芝加哥\n#华盛顿\n纽约\n洛杉矶'), ('26', '1', '0', '1', null, '作业说明'), ('26', '2', '0', '2', null, '附件列表\n\n讲义: aa.ppt\n地图: map.jpg\n听写: tt.mp3\n'), ('26', '3', '0', '3', null, '链接\n\n百度: baidu.com\n维基: wiki.com'), ('26', '12', '0', '5', '0', '那些国家是拉丁美洲国家 \n\n美国 \n英国 \n#墨西哥 \n#巴西'), ('26', '13', '0', '6', '0', '唐诗中诗仙是指__A__，诗圣是指__B__。\n\n李白\n杜甫'), ('26', '19', '0', '7', '0', '请简要说明北京作为中国政治中心的历史。');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `questions` VALUES ('1', 'M00001', 0x4d, '11', null, '三角形的内角之和为:', '90度\n#180度\n270度\n360度', '6', '5', null, '23560932', null, '0'), ('2', 'G000003', 0x47, '11', null, '美国首都是', '华盛顿\n纽约\n洛杉矶\n芝加哥', '8', '5', null, '23562917', null, '0'), ('3', 'G000004', 0x47, '12', null, '下列那些国家是欧洲国家', '摩洛哥\n#土耳其\n伊朗\n#乌克兰', '9', '5', null, '23562791', null, '1'), ('4', 'G000005', 0x47, '13', null, '中国的英文简称为__A__，美国的英文简称为__B__。', 'CN,CHN\nUS,USA', '1', '5', null, '23560948', null, '0'), ('5', 'G000009', 0x47, '21', null, '简要概述四川主要旅游景点', '', '1', '5', null, '23563136', null, '0'), ('6', 'G100012', 0x47, '12', null, '下列那些城市不在东半球', null, '10', null, null, '23564582', null, '0'), ('7', 'G100012', 0x47, '12', null, '下列那些城市不在东半球？', '东京\n新加坡\n伦敦\n✓德黒兰\n#洛杉矶', '9', null, null, '23564585', null, '0'), ('8', 'G100015', 0x47, '12', null, '下列那些城市不是首都', '#洛杉矶\n巴黎\n里约热内卢\n#伊斯坦布尔\n', '8', '5', null, '23564596', null, '0'), ('9', 'G100016', 0x47, '12', null, '下列那些城市不是首都', '#洛杉矶\n巴黎\n里约热内卢\n#伊斯坦布尔\n', '8', '5', null, '23564598', null, '0'), ('10', 'H100039', 0x48, '19', null, '请简要说明北京作为中国政治中心的历史。', '', '9', '5', null, '23564626', null, '0');
COMMIT;
